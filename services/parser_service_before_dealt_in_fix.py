...
class ParserService:
    ...
    def _parse_stars_style_hand(
        ...
        # Seat satırında bulunup bu ele dealt-in olmayan/sitting-out
        # oyuncuları istatistiklerden çıkar.
        active_player_names = {
        ...
        # Aksiyon bulunmayan bozuk bir elde tüm oyuncuları silmeyelim.
        if active_seats:
            active_positions = self._calculate_positions(
                seats=active_seats,
                button_seat=button_seat,
                max_seats=len(active_seats),
            )
